        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Course Content Upload</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
           <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Course Content Upload</h3>
              </div>
           ...
           <div class="card-body">
            <div class="row">
             ...
             <div class="col-md-4">
              ...
              <input id="radioVedio" name="isImgOrVideo" type="radio" <?php if($course_content_upload_info->is_img_or_video ==1) {echo "checked";} ?> value="1">
              Video &nbsp;&nbsp;
              <input id="radioImage" name="isImgOrVideo" <?php if($course_content_upload_info->is_img_or_video ==0) {echo "checked";} ?> type="radio" value="0">
              Image
            </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                   <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                         <input type="hidden" name="course_content_upload_id" vallue="<?php echo $course_content_upload_info->id; ?>">
